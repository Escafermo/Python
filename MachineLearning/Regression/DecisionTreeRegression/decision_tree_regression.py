...
# FIT DECISION TREE REGRESSION TO MODEL
...
# VISUALIZE DECISION TREE REGRESSION ONLY IN HIGH RES (NON-CONTINUOUS)
...
plt.plot(x_grid, decision_tree_regressor.predict(x_grid), color = 'green')
